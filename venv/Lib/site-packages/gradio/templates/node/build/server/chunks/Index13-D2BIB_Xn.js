import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-FJHii0oS.js';
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-CmHGT4pL.js';
import Example from './Example6-CLl1pGqC.js';
...
function ensureAnchor(expr, start) {
  ...
  if (!addEnd)
    return expr;
  return new RegExp(`${""}(?:${source})${addEnd ? "$" : ""}`, (_a2 = expr.flags) !== null && _a2 !== void 0 ? _a2 : expr.ignoreCase ? "i" : "");
}
...
const lang_map = {
  python: () => import('./index29-DuM-SkQ9.js').then((m) => m.python()),
  c: () => import('./clike-DVPZdfGU.js').then(
    (m) => StreamLanguage.define(m.c)
  ),
  cpp: () => import('./clike-DVPZdfGU.js').then(
    (m) => StreamLanguage.define(m.cpp)
  ),
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-DaiOT-pi.js'),
      import('./frontmatter-CxbYigSc.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-CYMfwFHb.js').then((m) => m.json()),
  html: () => import('./index31-CsF2ufm8.js').then((m) => m.html()),
  css: () => import('./index32-CA5-fHd2.js').then((m) => m.css()),
  javascript: () => import('./index33-SCIWMp-l.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-SCIWMp-l.js').then(
    (m) => m.javascript({ typescript: true })
  ),
  yaml: () => import('./yaml-BZBlrf2X.js').then(
    (m) => StreamLanguage.define(m.yaml)
  ),
  dockerfile: () => import('./dockerfile-DqOYFHIN.js').then(
    (m) => StreamLanguage.define(m.dockerFile)
  ),
  shell: () => import('./shell-B97p7zGG.js').then(
...
const Code = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.show_line_numbers === void 0 && $$bindings.show_line_numbers && show_line_numbers !== void 0)
    $$bindings.show_line_numbers(show_line_numbers);
...
export { ParseContext as A, bracketMatchingHandle as B, CompletionContext as C, DefaultBufferLength as D, EditorSelection as E, EditorView as F, continuedIndent as G, flatIndent as H, IterMode as I, sublanguageProp as J, Index$1 as K, LRLanguage as L, NodeSet as N, Parser as P, StreamLanguage as S, Tree as T, NodeType as a, NodeProp as b, foldInside as c, syntaxTree as d, indentNodeProp as e, foldNodeProp as f, delimitedIndent as g, LanguageSupport as h, ifNotIn as i, completeFromList as j, NodeWeakMap as k, snippetCompletion as l, Tag as m, countColumn as n, Prec as o, parseMixed as p, keymap as q, EditorState as r, styleTags as s, tags as t, Language as u, indentUnit as v, defineLanguageFacet as w, languageDataProp as x, foldService as y, LanguageDescription as z };
//# sourceMappingURL=Index13-D2BIB_Xn.js.map
