const __vite__fileDeps=["./index.CDG54xoT.js","./index.CfkJujYv.js","./index.CeUvkhIB.js","./index.WH5WtzEy.js","./index.DiH-fdJM.js","./index.DcrLRhOo.js","./frontmatter.K3Nb37Ot.js","./yaml.BMKOA8H-.js","./index.BOmqkFiA.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { f as getWorkerProxyContext, I as IconButton, K as Check, N as Copy$1, B as Block, S as Static } from "./2.ZoAk1G5g.js";
import { D as Download$1 } from "./Download.BLM_J5wv.js";
import { D as DownloadLink } from "./DownloadLink.DLHhRf1z.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.BXzPYNtk.js";
import { C as Code$2 } from "./Code.VKlWzMBL.js";
import { B as BlockLabel } from "./BlockLabel.BlIIaWZY.js";
import { E as Empty } from "./Empty.DLFCD-1c.js";
...
function buildTree(data) {
  ...
  function takeFlatNode(parentStart, minPos, children3, positions2) {
    ...
    if (nodeCount) {
      ...
      children3.push(new TreeBuffer(buffer2, nodes[2] - start, nodeSet2));
      positions2.push(start - parentStart);
    }
  }
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.CDG54xoT.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  c: () => __vitePreload(() => import("./clike.BcTWDAaS.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.c)
  ),
  cpp: () => __vitePreload(() => import("./clike.BcTWDAaS.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.cpp)
  ),
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.CeUvkhIB.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.K3Nb37Ot.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.BOmqkFiA.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.WH5WtzEy.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.DiH-fdJM.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.DcrLRhOo.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.DcrLRhOo.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
  ...
  dockerfile: () => __vitePreload(() => import("./dockerfile.Bp-_ryIT.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.dockerFile)
  ),
  shell: () => __vitePreload(() => import("./shell.B-lPp_H9.js"), true ? [] : void 0, import.meta.url).then(
...
function create_pyodide_autocomplete() {
  ...
  return async function pyodide_autocomplete(context) {
    try {
      const completions = await worker_proxy.getCodeCompletions({
        ...
        line: context.state.doc.lineAt(context.state.selection.main.head).number,
        column: context.state.selection.main.head - context.state.doc.lineAt(context.state.selection.main.head).from
      });
      if (completions.length === 0) {
        return null;
      }
      return {
        from: context.state.selection.main.head - completions[0].completion_prefix_length,
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  let { show_line_numbers = true } = $$props;
  ...
  async function get_lang(val) {
    ...
    $$invalidate(15, lang_extension = ext);
  }
  ...
  function get_extensions() {
    const stateExtensions = [
      ...get_base_extensions(basic, use_tab, placeholder$12, readonly, lang_extension, show_line_numbers),
      FontTheme,
      ...get_theme(),
      ...extensions
    ];
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("show_line_numbers" in $$props2)
      $$invalidate(13, show_line_numbers = $$props2.show_line_numbers);
    if ("autocomplete" in $$props2)
      $$invalidate(14, autocomplete = $$props2.autocomplete);
  };
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*lang_extension, readonly*/
    33792) {
      reconfigure();
    }
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty & /*show_line_numbers*/
      16384)
        code_changes.show_line_numbers = /*show_line_numbers*/
        ctx2[14];
      if (dirty & /*autocomplete*/
      32768)
        code_changes.autocomplete = /*autocomplete*/
        ctx2[15];
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      4096)
        ...
        ctx2[12];
      if (dirty & /*$$scope, value, interactive, language, lines, max_lines, wrap_lines, show_line_numbers, autocomplete, gradio, show_label, label, loading_status*/
      16901919) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("show_line_numbers" in $$props2)
      $$invalidate(14, show_line_numbers = $$props2.show_line_numbers);
    if ("autocomplete" in $$props2)
      $$invalidate(15, autocomplete = $$props2.autocomplete);
...
export {
  ...
  LanguageSupport as h,
  ifNotIn as i,
  completeFromList as j,
  NodeWeakMap as k,
  snippetCompletion as l,
  Tag as m,
  countColumn as n,
  Prec as o,
  parseMixed as p,
  ...
  Language as u,
  indentUnit as v,
  defineLanguageFacet as w,
  languageDataProp as x,
  foldService as y,
  LanguageDescription as z
};
